...
_FACTORY_VERSION = "v2.6.0-day3"  # bumped on each Phase 8 milestone
    ...
    def compile(self, dag: ResolvedDAG) -> str:
        ...
        app_dict: dict[str, Any] = {
            ...
            "app": {
                ...
                "mode": "workflow",
                "icon": "\U0001F3ED",  # factory icon
                "icon_background": "#FFEAD5",
                "description": (
                    f"[FACTORY · {_FACTORY_VERSION}] specimen_id={dag.intent_ref} "
                    f"pattern={dag.pattern_id or 'none'} target={dag.target}\n"
                    f"Generated by agent-ops V2.0.0 lights-out factory. "
                    f"Direct edits in Dify will be detected as drift on next factory pull."
                ),
            ...
            "_factory_metadata": {
                ...
                "specimen_id": dag.intent_ref,
                "generator": "agent-ops factory · DifyCompilerImpl V2",
                "warning_to_human_editor": (
                    "This workflow was generated by the agent-ops factory. "
                    "Edits made directly in Dify will be detected as drift "
                    "and may be overwritten on next factory deploy."
                ),
            },
        }
        out = yaml.safe_dump(
